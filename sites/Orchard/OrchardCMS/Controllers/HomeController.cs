...
namespace OrchardCMS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(string text)
        {
            ...
            return RedirectToAction("Display", "Home", new { area = "OrchardCMS", contentItemId = contentItem.ContentItemId });
        }
        ...
        public async Task<ActionResult> Tag(string tag)
        {
            ...
            return RedirectToAction(nameof(Tag), "Home", new { area = "OrchardCMS" });
        }
